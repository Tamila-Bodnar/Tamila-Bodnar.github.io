const questions = [
    ...
    },
    {
        ...
        'question': 'When did 19 NATO members and 11 \'Partners for Peace\' join hands for'+
        ' peace plan for Kosovo Crisis?'
    },
    {
    ...
    {
        'question' : 'When you enter a situation without a definite plan of action, you are'+
        ' said to be \'playing it by\' what?',
        'content' : [
            'Fingertips',
            'Ear',
            'Nose',
    ...
    },
    {
        ...
        'question': 'The escape velocity of a rocket fired from the earth towards the'+
        ' moon is the velocity required to overcome'
    },
    {
        'correct': 3,
        'content': [
